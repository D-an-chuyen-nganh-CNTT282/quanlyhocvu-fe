...
export class BusinessCollaborationService {
  private apiUrl = `${environment.apiBaseUrl}/businesscollaboraton`;
  ...
  update(payload: any, id: string): Observable<ApiResponse> {
    return this.http.put<ApiResponse>(`${this.apiUrl}?id=${id}`, payload, {
