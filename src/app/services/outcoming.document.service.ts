...
export class OutcomingDocumentService {
  private apiUrl = `${environment.apiBaseUrl}/outgoingdocument`;
  ...
  updateDocument(formData: FormData, params: HttpParams): Observable<ApiResponse> {
    return this.http.put<ApiResponse>(this.apiUrl, formData, { headers: this.getHeadersNotContentType(), params });
  }
